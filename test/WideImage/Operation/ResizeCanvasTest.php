...
class ResizeCanvasTest extends WideImageTestCase
{
    public function testResizeCanvasUp(): void
    {
    ...
    public function testResizeCanvasDown(): void
    {
        $img = WideImage::createTrueColorImage(160, 120);
    ...
    public function testResizeCanvasPositionsCenter(): void
    {
    ...
    public function testResizeCanvasPositionsCorner(): void
    {
        $img = WideImage::createTrueColorImage(20, 20);
        $black = $img->allocateColor(0, 0, 0);
        $white = $img->allocateColor(255, 255, 255);
